...
class Page
{
    ...
    protected function pre()
    {
        if ($this->selfPage > 1 && $this->selfPage <= $this->totalPage) {
            return "<a href='" . $this->url . ($this->selfPage - 1) . page::$fix . "' class='pre'>{$this->desc['pre']}</a>";
        }
    ...
    public function next()
    {
        ...
        if ($this->selfPage < $this->totalPage) {
            return "<a href='" . $this->url . ($this->selfPage + 1) . self::$fix . "' class='next'>{$next}</a>";
        }
    ...
    {
        $str = '';
        $first = $this->selfPage == 1 ? "" : "<a href='{$this->url}1" . page::$fix . "' class='picList'><span><<</span></a>";
        $end = $this->selfPage >= $this->totalPage ? "" : "<a href='{$this->url}{$this->totalPage}" . self::$fix . "'  class='picList'><span>>></span></a>";
        $pre = $this->selfPage <= 1 ? "" : "<a href='{$this->url}" . ($this->selfPage - 1) . self::$fix . "'  class='picList'><span><</span></a>";
        $next = $this->selfPage >= $this->totalPage ? "" : "<a href='{$this->url}" . ($this->selfPage + 1) . self::$fix . "'  class='picList'><span>></span></a>";
...
";
    ...
    public function pres()
    {
        ...
        return $this->selfPage > $this->pageRow ? "<a href='" . $this->url . $num . self::$fix . "' class='pres'>前{$this->pageRow}页</a>" : "";
    }
    ...
    public function nexts()
    {
        ...
        return $this->selfPage + $this->pageRow < $this->totalPage ? "<a href='" . $this->url . $num . self::$fix . "' class='nexts'>后{$this->pageRow}页</a>" : "";
    }
    ...
    public function first()
    {
        ...
        return $this->selfPage - $this->pageRow > 1 ? "<a href='" . $this->url . "1'" . self::$fix . " class='first'>{$first}</a>" : "";
    }
    ...
    {
        $end = $this->desc ['end'];
        return $this->selfPage < $this->totalPage - $this->pageRow ? "<a href='" . $this->url . $this->totalPage . self::$fix . "' class='end'>{$end}</a>" : "";
    }
